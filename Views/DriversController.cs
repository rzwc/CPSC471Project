...
namespace RestaurantMS.Views
{
    public class DriversController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Driver_ID,Drivers_License_Number,Account_Id")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Driver_ID,Drivers_License_Number,Account_Id")] Driver driver)
        {
